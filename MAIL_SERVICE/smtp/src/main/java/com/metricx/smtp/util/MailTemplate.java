package com.metricx.smtp.util;

public class MailTemplate {
    public static String otpMailHtmlContent(String otp) {
        return """
<html>
<head>
    <style>
...
<body>
    <div class="container">
        <div class="content">
            ...
            <p>This OTP is valid for the next 8 minutes. If you did not request this, please ignore this message.</p>
            <p class="notice">
    ...
    public static String greetingMailHtmlContent(String name) {
        return """
        <html>
        <head>
            <style>
        ...
        <body>
            <div class="container">
                <div class="content">
                    <div class="header">Welcome to MetricX, 
                    """ + name + """
                    !</div>
                    <p class="intro">Dear 
                    """ + name + """
